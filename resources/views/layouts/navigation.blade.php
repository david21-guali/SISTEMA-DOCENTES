<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('innovations.index')" :active="request()->routeIs('innovations.*')">
                        {{ __('Innovación') }}
                    </x-nav-link>
                ...
                <x-dropdown align="right" width="60">
                    ...
                    <x-slot name="content">
                        <div class="px-4 py-2 border-b border-gray-100 dark:border-gray-700">
                            <span class="text-sm font-semibold text-gray-700 dark:text-gray-300">Notificaciones</span>
                        </div>

                        @forelse(Auth::user()->unreadNotifications->take(5) as $notification)
                            <x-dropdown-link :href="route('notifications.read', $notification->id)">
                                <div class="flex flex-col">
                                    <span class="font-medium text-sm">{{ $notification->data['title'] ?? 'Notificación' }}</span>
                                    <span class="text-xs text-gray-500 truncate">{{ $notification->data['message'] ?? '' }}</span>
                        ...
                        <div class="border-t border-gray-100 dark:border-gray-700">
                            <x-dropdown-link :href="route('notifications.index')" class="text-center text-indigo-600 font-medium">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('innovations.index')" :active="request()->routeIs('innovations.*')">
                {{ __('Innovación') }}
            </x-responsive-nav-link>
