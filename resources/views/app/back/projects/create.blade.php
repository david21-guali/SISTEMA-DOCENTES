                    ...
                    <form action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="border border-2 border-dashed rounded p-4 text-center bg-light" id="createDropZone" style="cursor: pointer;">
                                ...
                                <input type="file" name="attachments[]" id="createFileInput" class="d-none" multiple 
            ...
            selectedFiles.forEach((file, index) => {
                ...
                setTimeout(() => {
                    ...
                    if (isPreviewable) {
                        ...
                        // Inicializar tooltip de Bootstrap para el botón deshabilitado si se desea
                        // new bootstrap.Tooltip(img.querySelector('.disabled')); 
                    }
                }, 10);
            });
